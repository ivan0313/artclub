    ...
    <React.Fragment>
      ...
      <nav className="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div className="container px-4 px-lg-5">
          <a className="navbar-brand" href="index.html">ART CLUB, HKUSU</a>
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto py-4 py-lg-0">
              ...
              <li className="nav-item"><a className="nav-link px-lg-3 py-3 py-lg-4" href="events.html">Events</a></li>
              <li className="nav-item"><a className="nav-link px-lg-3 py-3 py-lg-4" href="gallery.html">Gallery</a></li>
